...
INSERT INTO Contatto (Id, Nome, Cognome, Telefono, Email, Messaggio) VALUES ('1','Giulia','Fiorese','0000000000','giulia.fiorese.1@studenti.unipd.it','ISCRIZIONE'), ('2','Giulia','Fiorese',NULL,'giulia.fiorese.1@studenti.unipd.it','Nelle vostre strutture accettate animali domestici? Grazie. Giulia');

INSERT INTO Prenotazione (Id, Username, Nome, Cognome, Telefono, Email, Messaggio, Checkin, Checkout, BeB, Persone) VALUES ('1','user','Giulia','Fiorese','000 0000000','giulia.fiorese.1@studenti.unipd.it','PRENOTAZIONE','2019-02-21','2019-02-23','alborgo','2'), ('2','user','Giulia','Fiorese','000 0000000','giulia.fiorese.1@studenti.unipd.it','Vorrei prenotare due camere matrimoniali, se possibile. Grazie. Giulia','2019-03-01','2019-03-03','cadorehaus','4');
