	...
	<body id="BandB">
        ...
        <div class="container">
            <div class="desc">
                ...
                <p>
		    Abbiamo tre camere, di cui due con bagno privato interno, la terza con bagno privato esterno alla stanza; ogni camera ha 			    l&apos;impianto di riscaldamento e di climatizzazione.<br/><a href="ilBorgo.php" target="_blank">Maggiori informazioni</a>
		</p>
            </div>
            <ul>
                <li>+39 0000 000000</li>
                <li>Via Ventolone, 435032 Arqu&agrave; Petrarca (PD)</li>
        ...
        <div class="container">
            <div class="desc">
                ...
                <p>
		    Nel nostro B&amp;B ogni camera &egrave; dotata di arredamento completo: letti (possibilità a scelta di letto matrimoniale o 		    di due letti separati), comodini, divano, set di biancheria da camera completo, televisore, fornitura di energia elettrica, 		    riscaldamento, aria condizionata e servizio di pulizie quotidiane.<br/><a href="boscoverde.php">Maggiori informazioni</a>
		</p>
            </div>
            <ul>
        ...
        <div class="container">
            <div class="desc">
                ...
                <img src="img/cadorehaus.png" alt="B&amp;B Cadore Haus"/>
                <p>
		    Nel cuore delle Dolomiti, la Cadore Haus offre momenti di assoluto relax a contatto con la natura. La casa vanta stanze 			    accoglienti e curate. La costruzione si trova nel centro del paese, a pochi passi dalla chiesa di San Lucano, nella 		    frazione di Villapiccola.<br/><a href="cadorehaus.php" target="_blank">Maggiori informazioni</a>
		</p>
            </div>
            <ul>
                <li>Telefono: +39 0000 000000</li>
        ...
        <div class="container">
            <div class="desc">
                ...
                <p>
		   Le camere sono climatizzate e includono arredi in stile classico e moderno e un bagno privato. Ogni mattina viene servita 			   una colazione dolce a base di prodotti da forno, marmellate e bevande calde e fredde.<br/><a href="lacorte.php">Maggiori 			   informazioni</a>
		</p>
            </div>
            <ul>
                <li>Telefono: +39 0000 000000</li>
        ...
        <div class="container">
            <div class="desc">
                ...
                <p>
		    Situato a Caviola, a 7 minuti dal impianto di risalita del comprensorio sciistico San Pellegrino, la Stella del Viandante 			    offre connessione Wi&ndash;Fi e parcheggio privato gratuiti.<br/><a href="stellaviandante.php" target="_blank">Maggiori 			    informazioni</a>
		</p>
            </div>
            <ul>
                <li>Telefono: +39 0000 000000</li>
