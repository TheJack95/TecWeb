...
<div class="tutto">
    <img id="imgBeB" src="img/B&B_Falcade.jpg" alt="B&B Falcade"/>  
    <img id="logoBeB" src="img/logoB&B_Falcade.jpg" alt="Logo Stella del Viandante"/>	
    <ul id="info">
        <li>Telefono: 00000000 </li>
        <li>Indirizzo: Via Danilo Busin 7, Falcade </li>
        <li><a href= "https://goo.gl/maps/6zV9aQedXPy" target="_blank">Vedi sulla mappa</a></li>
